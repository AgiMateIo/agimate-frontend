...
object AgimateTokens {
    object Colors {
        ...
        object Dark {
            ...
            val markInk = Color(0xFF6366F1)
            val markInkLight = Color(0xFFA5B4FC)
            val accentGlow = Color(0x4D6366F1)
        ...
        object Light {
            ...
            val warning = Color(0xFFF59E0B)
            val error = Color(0xFFEF4444)
            val markInk = Color(0xFF4F46E5)
            val markInkLight = Color(0xFF818CF8)
            val accentGlow = Color(0x4D4F46E5)
