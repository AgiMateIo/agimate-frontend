...
public enum AgimateTokens {
    public enum Colors {
        ...
        public enum Dark {
            ...
            public static let accent = Color(.sRGB, red: 0.3882, green: 0.4000, blue: 0.9451, opacity: 1.0)
            ...
            public static let markInk = Color(.sRGB, red: 0.3882, green: 0.4000, blue: 0.9451, opacity: 1.0)
            public static let markInkLight = Color(.sRGB, red: 0.6471, green: 0.7059, blue: 0.9882, opacity: 1.0)
            public static let accentGlow = Color(.sRGB, red: 0.3882, green: 0.4000, blue: 0.9451, opacity: 0.3020)
        ...
        public enum Light {
            ...
            public static let accent = Color(.sRGB, red: 0.3098, green: 0.2745, blue: 0.8980, opacity: 1.0)
            public static let accentForeground = Color(.sRGB, red: 1.0000, green: 1.0000, blue: 1.0000, opacity: 1.0)
            public static let success = Color(.sRGB, red: 0.1333, green: 0.7725, blue: 0.3686, opacity: 1.0)
            public static let warning = Color(.sRGB, red: 0.9608, green: 0.6196, blue: 0.0431, opacity: 1.0)
            public static let error = Color(.sRGB, red: 0.9373, green: 0.2667, blue: 0.2667, opacity: 1.0)
            public static let markInk = Color(.sRGB, red: 0.3098, green: 0.2745, blue: 0.8980, opacity: 1.0)
            public static let markInkLight = Color(.sRGB, red: 0.5059, green: 0.5490, blue: 0.9725, opacity: 1.0)
            public static let accentGlow = Color(.sRGB, red: 0.3098, green: 0.2745, blue: 0.8980, opacity: 0.3020)
